export const mainnetNetworks = {
  ...
  mainnet: {
    ...
    lqMintTokenSymbolBlackList: ["DOMI", "oneDODO", "OLO", "PSP", "WXT", "PEOPLE", "SOS", "FRAX"],
  },
  bsc: {
    name: "BSC",
    color: "#7057ff",
    ...
    lqMintTokenSymbolBlackList: ["DOMI", "oneDODO", "OLO", "PSP", "ATL", "PEOPLE", "SOS", "FRAX"],
  },
  ...
  polygon: {
    ...
    tokenSymbolList: ["USDC", "USDT", "WETH", "IMX", "WXT", "ATL", "FRAX"],
    lqMintTokenSymbolBlackList: ["WXT", "ATL", "FRAX"],
  },
  ...
  arbitrum: {
    ...
    tokenSymbolList: ["USDC", "USDT", "WETH", "DODO", "MCB", "IMX", "XTK", "FRAX"],
    lqMintTokenSymbolBlackList: ["FRAX"],
  },
  Avalanche: {
    name: "Avalanche",
    color: "#3099f2",
    ...
    tokenSymbolList: ["USDC", "USDT", "WETH", "IMX", "WXT", "PEOPLE", "SOS", "FRAX"],
    lqMintTokenSymbolBlackList: ["WXT", "PEOPLE", "SOS", "FRAX"],
  },
  Optimism: {
    name: "Optimism",
    color: "#3099f2",
  ...
  Fantom: {
    ...
    tokenSymbolList: ["USDC", "USDT", "WETH", "PEOPLE", "SOS", "FRAX"],
    lqMintTokenSymbolBlackList: ["PEOPLE", "SOS", "FRAX"],
  },
  FantomTestnet: {
    name: "Fantom Testnet",
    color: "#3099f2",
  ...
  Harmony: {
    ...
    tokenSymbolList: ["FRAX", "PEOPLE", "SOS"],
    lqMintTokenSymbolBlackList: ["FRAX", "PEOPLE", "SOS"],
  },
  ...
  //   tokenSymbolList: ["BNB", "AVAX"],
  //   lqMintTokenSymbolBlackList: ["BNB", "AVAX"],
  // },
