...
export interface MintSwapCanonicalTokenUpgradableFreezableInterface extends utils.Interface {
...
export interface MintSwapCanonicalTokenUpgradableFreezable extends BaseContract {
  contractName: "MintSwapCanonicalTokenUpgradableFreezable";
  ...
  functions: {
    ...
    freeze(_account: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  unfreeze(_account: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    freeze(_account: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
    ...
    unfreeze(_account: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
