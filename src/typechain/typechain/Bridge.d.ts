...
export class Bridge extends BaseContract {
  ...
  callStatic: {
    ...
    setMaxSend(_tokens: string[], _amounts: BigNumberish[], overrides?: CallOverrides): Promise<void>;

    setMinAdd(_tokens: string[], _amounts: BigNumberish[], overrides?: CallOverrides): Promise<void>;

    setMinSend(_tokens: string[], _amounts: BigNumberish[], overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    ResetNotification(resetTime?: null): TypedEventFilter<[BigNumber], { resetTime: BigNumber }>;
    ...
    SignersUpdated(
      _signers?: null,
      _powers?: null,
    ): TypedEventFilter<[string[], BigNumber[]], { _signers: string[]; _powers: BigNumber[] }>;
  ...
  populateTransaction: {
    ...
    maxSend(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    minAdd(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;

    minSend(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    transfers(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
