...
import type { MessageReceiverApp, MessageReceiverAppInterface } from "../MessageReceiverApp";
...
export class MessageReceiverApp__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): MessageReceiverApp {
