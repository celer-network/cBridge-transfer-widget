...
export class OriginalTokenVault extends BaseContract {
  ...
  filters: {
    DelayPeriodUpdated(period?: null): TypedEventFilter<[BigNumber], { period: BigNumber }>;

    DelayThresholdUpdated(
      token?: null,
      threshold?: null,
    ): TypedEventFilter<[string, BigNumber], { token: string; threshold: BigNumber }>;
    ...
    EpochLengthUpdated(length?: null): TypedEventFilter<[BigNumber], { length: BigNumber }>;
    ...
    GovernorAdded(account?: null): TypedEventFilter<[string], { account: string }>;

    GovernorRemoved(account?: null): TypedEventFilter<[string], { account: string }>;
    ...
    PauserAdded(account?: null): TypedEventFilter<[string], { account: string }>;

    PauserRemoved(account?: null): TypedEventFilter<[string], { account: string }>;
