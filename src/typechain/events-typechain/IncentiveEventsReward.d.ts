...
interface IncentiveEventsRewardInterface extends ethers.utils.Interface {
  functions: {
    ...
    "claimReward(address,uint256,uint256,bytes)": FunctionFragment;
    "claimedRewardAmounts(uint256,address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "claimReward", values: [string, BigNumberish, BigNumberish, BytesLike]): string;
  encodeFunctionData(functionFragment: "claimedRewardAmounts", values: [BigNumberish, string]): string;
  ...
  events: {
    "IncentiveRewardClaimed(address,uint256)": EventFragment;
    "IncentiveRewardContributed(address,uint256)": EventFragment;
...
export type IncentiveRewardClaimedEvent = TypedEvent<[string, BigNumber] & { recipient: string; reward: BigNumber }>;

export type IncentiveRewardContributedEvent = TypedEvent<
  [string, BigNumber] & { contributor: string; contribution: BigNumber }
>;
...
export class IncentiveEventsReward extends BaseContract {
  ...
  functions: {
    ...
    claimedRewardAmounts(arg0: BigNumberish, arg1: string, overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    "IncentiveRewardClaimed(address,uint256)"(
      recipient?: string | null,
      reward?: null,
    ): TypedEventFilter<[string, BigNumber], { recipient: string; reward: BigNumber }>;
    ...
    "IncentiveRewardContributed(address,uint256)"(
      contributor?: string | null,
      contribution?: null,
    ): TypedEventFilter<[string, BigNumber], { contributor: string; contribution: BigNumber }>;
  ...
  populateTransaction: {
    ...
    claimedRewardAmounts(arg0: BigNumberish, arg1: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
