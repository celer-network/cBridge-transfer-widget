  ...
  proto.sgn.message.v1.MsgSignFees.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        sender: jspb.Message.getFieldWithDefault(msg, 2, ""),
        signatureDetailsListList: jspb.Message.toObjectList(
          msg.getSignatureDetailsListList(),
          proto.sgn.message.v1.SignatureDetails.toObject,
          includeInstance,
        ),
      };
...
proto.sgn.message.v1.MsgSignFees.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(3, f, proto.sgn.message.v1.SignatureDetails.serializeBinaryToWriter);
  }
};
