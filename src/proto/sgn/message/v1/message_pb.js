...
proto.sgn.message.v1.Message.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(9, f, sgn_common_v1_common_pb.Signature.serializeBinaryToWriter);
  }
...
proto.sgn.message.v1.ExecutionContext.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(2, f, proto.sgn.message.v1.Message.serializeBinaryToWriter);
  }
  f = message.getTransfer();
  if (f != null) {
    writer.writeMessage(3, f, proto.sgn.message.v1.Transfer.serializeBinaryToWriter);
  }
  ...
  proto.sgn.message.v1.FeeClaimDetails.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        cumulativeFeeAmount:
          (f = msg.getCumulativeFeeAmount()) && cosmos_base_v1beta1_coin_pb.DecCoin.toObject(includeInstance, f),
        signaturesList: jspb.Message.toObjectList(
          msg.getSignaturesList(),
          sgn_common_v1_common_pb.Signature.toObject,
          includeInstance,
  ...
  proto.sgn.message.v1.FeeClaimInfo.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        feeClaimDetailsListList: jspb.Message.toObjectList(
          msg.getFeeClaimDetailsListList(),
          proto.sgn.message.v1.FeeClaimDetails.toObject,
          includeInstance,
        ),
      };
...
proto.sgn.message.v1.FeeClaimInfo.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(3, f, proto.sgn.message.v1.FeeClaimDetails.serializeBinaryToWriter);
  }
};
  ...
  proto.sgn.message.v1.MsgProposal.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        messageBusesList: jspb.Message.toObjectList(
          msg.getMessageBusesList(),
          proto.sgn.message.v1.MessageBusInfo.toObject,
          includeInstance,
        ),
...
proto.sgn.message.v1.MsgProposal.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(3, f, proto.sgn.message.v1.MessageBusInfo.serializeBinaryToWriter);
  }
