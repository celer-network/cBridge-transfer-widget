  ...
  proto.sgn.sync.v1.PendingUpdate.toObject = function (includeInstance, msg) {
    var f,
      obj = {
        ...
        votesList: jspb.Message.toObjectList(msg.getVotesList(), proto.sgn.sync.v1.Vote.toObject, includeInstance),
...
proto.sgn.sync.v1.PendingUpdate.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(7, f, proto.sgn.sync.v1.Vote.serializeBinaryToWriter);
  }
...
proto.sgn.sync.v1.Params.prototype.getTallyThreshold_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getTallyThreshold()));
};
...
proto.sgn.sync.v1.Params.prototype.getTallyThreshold_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getTallyThreshold()));
};
