...
goog.exportSymbol('proto.sgn.gateway.v1.CurrentBlockNumberReport', null, global);
...
goog.exportSymbol('proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest', null, global);
goog.exportSymbol('proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse', null, global);
 ...
 * @constructor
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.displayName = 'proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.sgn.gateway.v1.CurrentBlockNumberReport = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.sgn.gateway.v1.CurrentBlockNumberReport, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sgn.gateway.v1.CurrentBlockNumberReport.displayName = 'proto.sgn.gateway.v1.CurrentBlockNumberReport';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.displayName = 'proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.sgn.gateway.v1.Chain.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    suggestedBaseFee: jspb.Message.getFloatingPointFieldWithDefault(msg, 10, 0.0)
  };
...
/**
 * optional double suggested_base_fee = 10;
 * @return {number}
 */
proto.sgn.gateway.v1.Chain.prototype.getSuggestedBaseFee = function() {
 ...
 * @return {!proto.sgn.gateway.v1.Chain} returns this
 */
proto.sgn.gateway.v1.Chain.prototype.setSuggestedBaseFee = function(value) {
 ...
 * @return {!Object}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest;
  return proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!(string|Uint8Array)}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.prototype.getReport = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.prototype.getReport_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getReport()));
};
 ...
 * @return {!Uint8Array}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.prototype.getReport_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getReport()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest} returns this
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.prototype.setReport = function(value) {
  return jspb.Message.setProto3BytesField(this, 1, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.prototype.getSig = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {string}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.prototype.getSig_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getSig()));
};
 ...
 * @return {!Uint8Array}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.prototype.getSig_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getSig()));
};
 ...
 * @return {!proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest} returns this
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberRequest.prototype.setSig = function(value) {
  return jspb.Message.setProto3BytesField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.sgn.gateway.v1.CurrentBlockNumberReport.prototype.toObject = function(opt_includeInstance) {
  return proto.sgn.gateway.v1.CurrentBlockNumberReport.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sgn.gateway.v1.CurrentBlockNumberReport} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.gateway.v1.CurrentBlockNumberReport.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.sgn.gateway.v1.CurrentBlockNumberReport}
 */
proto.sgn.gateway.v1.CurrentBlockNumberReport.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sgn.gateway.v1.CurrentBlockNumberReport;
  return proto.sgn.gateway.v1.CurrentBlockNumberReport.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sgn.gateway.v1.CurrentBlockNumberReport} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sgn.gateway.v1.CurrentBlockNumberReport}
 */
proto.sgn.gateway.v1.CurrentBlockNumberReport.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.sgn.gateway.v1.CurrentBlockNumberReport.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sgn.gateway.v1.CurrentBlockNumberReport.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sgn.gateway.v1.CurrentBlockNumberReport} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.gateway.v1.CurrentBlockNumberReport.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.sgn.gateway.v1.CurrentBlockNumberReport.prototype.getTimestamp = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.sgn.gateway.v1.CurrentBlockNumberReport} returns this
 */
proto.sgn.gateway.v1.CurrentBlockNumberReport.prototype.setTimestamp = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!jspb.Map<string,number>}
 */
proto.sgn.gateway.v1.CurrentBlockNumberReport.prototype.getBlockNumsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,number>} */ (
      jspb.Message.getMapField(this, 2, opt_noLazyCreate,
      null));
};
 ...
 * @return {!proto.sgn.gateway.v1.CurrentBlockNumberReport} returns this
 */
proto.sgn.gateway.v1.CurrentBlockNumberReport.prototype.clearBlockNumsMap = function() {
 ...
 * @return {!Object}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    err: (f = msg.getErr()) && proto.sgn.gateway.v1.ErrMsg.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse;
  return proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getErr();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.sgn.gateway.v1.ErrMsg}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.prototype.getErr = function() {
  return /** @type{?proto.sgn.gateway.v1.ErrMsg} */ (
    jspb.Message.getWrapperField(this, proto.sgn.gateway.v1.ErrMsg, 1));
};
...
/**
 * @param {?proto.sgn.gateway.v1.ErrMsg|undefined} value
 * @return {!proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse} returns this
*/
proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.prototype.setErr = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse} returns this
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.prototype.clearErr = function() {
  return this.setErr(undefined);
};
 ...
 * @return {boolean}
 */
proto.sgn.gateway.v1.ReportCurrentBlockNumberResponse.prototype.hasErr = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.sgn.gateway.v1.GetCurrentBlockNumberByNodeResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    err: (f = msg.getErr()) && proto.sgn.gateway.v1.ErrMsg.toObject(includeInstance, f),
    reportsMap: (f = msg.getReportsMap()) ? f.toObject(includeInstance, proto.sgn.gateway.v1.CurrentBlockNumberReport.toObject) : [],
...
proto.sgn.gateway.v1.GetCurrentBlockNumberByNodeResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.sgn.gateway.v1.CurrentBlockNumberReport.deserializeBinaryFromReader, "", new proto.sgn.gateway.v1.CurrentBlockNumberReport());
         });
      break;
    case 3:
      var value = /** @type {string} */ (reader.readString());
...
proto.sgn.gateway.v1.GetCurrentBlockNumberByNodeResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(2, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.sgn.gateway.v1.CurrentBlockNumberReport.serializeBinaryToWriter);
  }
...
/**
 * map<string, CurrentBlockNumberReport> reports = 2;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.sgn.gateway.v1.CurrentBlockNumberReport>}
 */
proto.sgn.gateway.v1.GetCurrentBlockNumberByNodeResponse.prototype.getReportsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.sgn.gateway.v1.CurrentBlockNumberReport>} */ (
      jspb.Message.getMapField(this, 2, opt_noLazyCreate,
      proto.sgn.gateway.v1.CurrentBlockNumberReport));
};
